...
sudo rm -rf config/ content/ controller/ helpers/ middleware/ models/ node_modules/ public/ routes/ src/ utils/ views/ .babelrc .env .gitignore app.js ecosystem.config.js package.json postcss.config.js server.js webpack.common.js webpack.dev.js webpack.prod.js node_modules
cd ~
